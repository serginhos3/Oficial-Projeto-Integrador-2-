        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('pacientes.list')" :active="request()->routeIs('pacientes.list')">
                        {{ __('Pacientes') }}
                    </x-nav-link>
                    <x-nav-link :href="route('orcamentos.list')" :active="request()->routeIs('orcamentos.list')">
                        {{ __('Orçamentos') }}
                    </x-nav-link>
                </div>
            </div>
